...
public class two_depth_add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_depth_add);

        Intent intent=getIntent();
        getID=intent.getStringExtra("id");
        depthName1=intent.getStringExtra("depthName");
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                Intent intent=new Intent(two_depth_add.this, two_depth.class);
        ...
        btnCommit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(edtOne.getText().toString().isEmpty()){
                    ...
                    new AlertDialog.Builder(two_depth_add.this).setTitle("추가").setMessage("추가하시겠습니까 ?")
                            .setPositiveButton("추가", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        String str = new CustomTask().execute(depth, getID, content, depthName1,"insert").get(); // 몇뎁스인지, 어떤지점인지 알기위해 해당 매니저의 아이디를 같이 전송

                                        System.out.println("setOnClick: "+str);
                                        if(str.equals("성공")){
                                            Toast.makeText(two_depth_add.this, "처리되었습니다.",Toast.LENGTH_SHORT).show();
                                            finish();
                                            Intent intent=new Intent(two_depth_add.this, two_depth.class);
                                            intent.putExtra("id",getID);
                                            intent.putExtra("depthName",depthName1);
                                            ...
                                            Toast.makeText(two_depth_add.this, "중복된 값입니다.",Toast.LENGTH_SHORT).show();
                                        }
                    ...
                    public boolean onMenuItemClick(MenuItem item)
                    {
                        switch (item.getItemId()){
                            case R.id.m1:
                                ...
                                Intent intent1 = new Intent(two_depth_add.this, manager_serivce.class); // 받아온 아이디 다시 전달해주기
                            ...
                            case R.id.m2:
                                ...
                                Intent intent2 = new Intent(two_depth_add.this, manager_select_main.class); // 받아온 아이디 다시 전달해주기
                                ...
                                break;
                            case R.id.m3:
                                new AlertDialog.Builder(two_depth_add.this).setTitle("로그아웃").setMessage("로그아웃 하시겠습니까 ?")
                                        .setPositiveButton("로그아웃", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent intent = new Intent(two_depth_add.this, MainActivity.class);
                                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_SINGLE_TOP);
                                                ActivityCompat.finishAffinity(two_depth_add.this); // 모든 액티비티 다 종료후 로그인 화면으로 돌아감
                                                startActivity(intent);
                                            }
                                        })
                                        .setNegativeButton("취소", new DialogInterface.OnClickListener() {
    ...
    class CustomTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                sendMsg = "depth="+strings[0]+"&getID="+strings[1]+"&content="+strings[2]+"&depthName="+strings[3]+"&kind="+strings[4];
